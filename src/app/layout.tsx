    ...
    <html lang="en" className={`h-full ${inter.variable}`}>
      <body className="h-full">
        <div className="min-h-full flex flex-col">
          ...
          <footer className="py-6 text-center text-xs text-deep-teal/60">
            <a href="https://jarrang.com" className="hover:text-primary transition-colors" target="_blank" rel="noreferrer noopener">
              Built by Jarrang
            </a>
          </footer>
        </div>

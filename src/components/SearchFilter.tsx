    ...
    <div className="flex flex-col md:flex-row gap-3 mb-6">
      <div className="relative flex-grow">
        ...
        <input
          ...
          className="block w-full rounded-xl border-0 bg-white pl-10 pr-14 py-3 text-midnight-navy shadow-sm ring-1 ring-inset ring-soft-grey focus:ring-2 focus:ring-inset focus:ring-primary transition-all duration-200 placeholder:text-deep-teal/50"
          placeholder="Search by domain, ESP, or record contents…"
        />
        <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
          <kbd className="kbd" aria-hidden="true" title="Press / to focus search">/</kbd>
        </div>
      </div>
      ...
      <div className="flex gap-3 flex-wrap md:flex-nowrap">
        <div className="relative min-w-[180px] flex-1 md:flex-initial">
          ...
          <select
            ...
            className="block w-full rounded-xl border-0 bg-white pl-10 py-3 shadow-sm ring-1 ring-inset ring-soft-grey focus:ring-2 focus:ring-inset focus:ring-primary transition-all duration-200 appearance-none pr-8 text-deep-teal"
          >
